...
class NavigationReachabilityParameterizedTest(private val case: Case) : BaseTest() {
        ...
        fun data(): List<Any> {
            ...
            val cases =
                listOf(
                    ...
                    // pageName=SettingsEnhancedTrackingProtectionPage, property=settingsEnhancedTrackingProtection,
                    // paths=1
                    Case(
                    ...
                    // pageName=SettingsEnhancedTrackingProtectionExceptionsPage,
                    // property=settingsEnhancedTrackingProtectionExceptions, paths=1
                    Case(
